                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input required type="tel" className="w-full pl-10 pr-4 py-3 bg-zinc-50 border border-zinc-100 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 outline-none transition-all" placeholder="(602) 279-2665" />
                                        </div>
                                    </div>
                                    <div>
