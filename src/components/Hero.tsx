      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 text-sm font-medium text-sky-300 mb-6"
          >
          ...
          <h1 className="font-display font-bold text-5xl md:text-7xl text-white leading-[1.1] mb-6 tracking-tight">
            Cool Relief from the <span className="text-sky-400">Arizona Heat.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-sky-500 hover:bg-sky-600 text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-sky-500/20 flex items-center justify-center gap-2 group"
            >
              Schedule Service
          ...
          <div className="flex items-center gap-4 text-white/90">
            <div className="flex -space-x-3">
              ...
              <div className="w-10 h-10 rounded-full border-2 border-slate-900 bg-sky-600 flex items-center justify-center text-xs font-bold">
                500+
              </div>
            </div>
